...
void main() {
	// GeoTwin: Natural greenish terrain for unmapped areas (tropical vegetation)
	vec3 originalBiomeColor = texture(tBiomeMap, biomeCoordinates).rgb * 2.2;
	vBiomeColor = vec3(0.85, 0.90, 0.75); // Natural greenish color for Dominica's terrain
