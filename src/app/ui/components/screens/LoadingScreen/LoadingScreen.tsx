...
const IssuesURL = 'https://github.com/AzyAli/GeoTwin/issues';
...
const LoadingScreen: React.FC = () => {
	...
	>
		<div className={classes.loadingScreen}>
			<div className={classes.loadingScreen__title}>GeoTwin</div>
			<div className={classes.loadingScreen__subtitle}>Dominica Digital Twin Platform</div>
			...
			<div className={classes.loadingScreen__filePath}>{
				loadingPath ? `Loading ${loadingPath}` : 'Initializing 3D Environment...'
			}</div>
