// Terrain system is where I spent WEEKS getting elevation data right
// ESRI's elevation service is solid but man, getting it to work smoothly
// with the ring-based terrain system took some serious debugging
// The key was understanding how the tile coordinates map to world space
// and making sure the height sampling works perfectly for flood planes
