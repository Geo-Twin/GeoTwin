...
// GeoTwin: SSAOPass removed for performance optimization
...
export default class RenderSystem extends System {
	...
	private initScene(): void {
		...
		// Look, I had to make some tough choices here about performance
		// Originally had all the fancy effects - TAA, shadows, bloom, the works
		// But for flood assessment, we need SPEED over pretty effects
		// Emergency planners don't care about fancy shadows when they're trying
		// to figure out evacuation routes during a storm
		// So I stripped it down to just what we actually NEED
	...
	public update(deltaTime: number): void {
		// Safety check: Don't update if passManager is not initialized
		if (!this.passManager) {
			return;
		}
